...
/**
*Добавление библиотек графического интерфейса
*/
import java.awt.*; 
/**
...
/**
* Объявление текстового поля Сумма
*/
...
/**
* Объявление текстового поля Год
*/
...
/**
* Объявление текстового поля Доход
*/
...
/**
* Объявление текстового поля Статус
*/
...
* Закрытие формы Кредитор и открытия формы Эскобар
*/
...
/**
* Объявление выпадающего списка Год
*/
JComboBox Years = new JComboBox();
/**
* Установка местоположения выпадающего списка Год
*/
method.Method.ComboBox(Years,false,201, 86, 69, 20);
/**
*Добавление выпадающего списка Год на форму
*/
...
/**
* Объявление выпадающего списка Месяцы
*/
...
/**
* Объявление выпадающего списка Категория
*/
JComboBox Category = new JComboBox();
/**
* Установка местоположения выпадающего списка Категория
*/
method.Method.ComboBox(Category,false,201, 154, 241, 20);
/**
* Добавление выпадающего списка Категория на форму 
*/
...
public void actionPerformed(ActionEvent arg0) {
/**
*Объявление объекта для расчета кредита
*/
...
/**
*  Добавление переменной Основной доход и присваивание ей значения из текстового поля Доход
*/
int mainProfit = Integer.parseInt(Income.getText());
/**
* Объявление переменной Года и присваивание ей значения из выпадающего списка годы
*/
...
/**
* Объявление переменной Категория заемщика и присваивание ей значения из выпадающего списка Категория
*/
...
/**
* Определение числа месяцев для кейса 1 означающего процентную ставку в размере 1.15
*/
case 0: bet = 0.15; break;
/**
* Определение числа месяцев для кейса 2 означающего процентную ставку в размере 1.12
*/
case 1: bet = 0.12; break;
/**
* Определение числа месяцев для кейса 3 означающего процентную ставку в размере 1.18
*/
...
*/
if (((sum*bet)/time > mainProfit) || (Integer.parseInt(Age.getText()) < 18)){
/**
* Установление текста "Отклонен" в текстовом поле Статус при выполнении условия
*/
Status.setText("Отклонен");
/**
* Объявление пустой строки в текстовом поле Оплата при выполнении условия 
*/
Payment.setText("");
/**
...
/**
* Установление текста "Одобрен" в текстовом поле Статус 
*/
